...
namespace stk {
    ...
    Goom :: Goom( void )
    {
        ...
        float a = 1512.45 / 1000.0f;
        float d = 1110.45 / 1000.0f;
        float s = .6;
        float r = 1731 / 1000.0f;
        
        //adsr_.setAllTimes(a, d, s, r);
        adsr_.setAllTimes(0.5, 1.5, 0.6, 0.250 );
    ...
    void Goom:: setFrequency( StkFloat frequency )
    {
    ...
    void Goom :: noteOn( StkFloat frequency, StkFloat amplitude )
    {
        StkFloat temp;
    ...
    void Goom :: controlChange( int number, StkFloat value )
    {
#if defined(_STK_DEBUG_)
